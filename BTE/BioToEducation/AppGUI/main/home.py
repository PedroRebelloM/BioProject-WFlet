...
def CriarLayout(page: ft.Page):
    ...
    containerTextoSequenciamento = ft.Container(
        content=texto, margin=ft.margin.only(left=25)
    )
    ...
    botaoCopiarA = ft.Container(
        ft.ElevatedButton(
            f"Copiar gene {fix.nomeGene1}",
            on_click=lambda _: funcoes.CopiarGeneA(linha, page),
            bgcolor="white",
            color="black",
            adaptive=True,
            height=30,
    ...
    botaoCopiarB = ft.Container(
        ft.ElevatedButton(
            f"Copiar gene {fix.nomeGene2}",
            on_click=lambda _: funcoes.CopiarGeneB(linha, page),
            bgcolor="white",
            color="black",
            adaptive=True,
            height=30,
