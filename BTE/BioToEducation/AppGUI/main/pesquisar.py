...
def CriarLayoutPesquisar(page: ft.Page):
    ...
    arquivo1 = ft.FilePicker(
        on_result=lambda e: funcoes.EscolherArquivoBancoDeDados(e, 1, page)
    )
    ...
    containerTextoBD = ft.Container(content=texto, margin=ft.margin.only(left=25))
    ...
    bancoSelected = ft.Dropdown(
        ...
        on_change=lambda e: print(
            f"Banco selecionado no dropdown: {bancoSelected.value}"
        ),  # Adiciona um print para verificar
        text_style=ft.TextStyle(
            color=ft.colors.BLACK, size=14, weight=ft.FontWeight.BOLD
        ),
    )
    ...
    botaoEscolherArquivo1 = ft.Container(
        ft.ElevatedButton(
            "Escolher arquivo para busca interna",
    ...
    botaoEscolherArquivoNCBI = ft.Container(
        ft.ElevatedButton(
            "Buscar no NCBI",
            on_click=lambda _: funcoes.buscarNoNCBI(
                page, bancoSelected.value, campoTexto, containerBD
            ),
            bgcolor="white",
            color="black",
            adaptive=True,
        ...
        content=ft.Column(
            [
                ...
                ft.Row(
                    [
                        ft.Container(
                            content=ft.Column([campoTexto, bancoSelected]),
    ...
    layoutAll = ft.Row(
        [
            ...
            ft.Container(
                ...
                content=ft.Column([containerMor, containerTextoBD, containerBD]),
            ),
        ],
        spacing=0,
        expand=True,
