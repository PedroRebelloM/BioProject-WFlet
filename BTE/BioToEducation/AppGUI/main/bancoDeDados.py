...
def CriarLayoutBancoDeDados(page: ft.Page):
    ...
    botaoPrimeiroGene = ft.ElevatedButton(
        ...
        width=400,
        height=30,
        on_click=lambda _: funcoes.BotaoPrimeiroGene(linha),
    )
    ...
    botaoSegundoGene = ft.ElevatedButton(
        ...
        width=400,
        height=30,
        on_click=lambda _: funcoes.BotaoSegundoGene(linha),
    )
    ...
    botaoEscolherArquivo1 = ft.Container(
        ft.ElevatedButton(
            "Escolher arquivo",
            on_click=lambda _: arquivoEnviado.pick_files(),
            bgcolor="white",
            color="black",
            adaptive=True,
            width=300,
    ...
    layoutAll = ft.Row(
        [
            ...
            ft.Container(
                ...
                content=ft.Column([containerMeusGenes, containerTextoBD, containerBD]),
            ),
        ],
        spacing=0,
        expand=True,
