...
def CriarLayoutTraducao(page: ft.Page):
    ...
    botaoPrimeiroGene = ft.ElevatedButton(
        ...
        width=400,
        height=30,
        on_click=lambda _: funcoes.BotaoATraducao(linha),
    )
    ...
    botaoCopiarA = ft.Container(
        ft.ElevatedButton(
            f"Copiar proteína {fix.nomeGene1}",
            on_click=lambda _: funcoes.CopiarTraducaoA(linha, page),
            bgcolor="white",
            color="black",
            adaptive=True,
            height=30,
    ...
    botaoCopiarB = ft.Container(
        ft.ElevatedButton(
            f"Copiar proteína {fix.nomeGene2}",
            on_click=lambda _: funcoes.CopiarTraducaoB(linha, page),
            bgcolor="white",
            color="black",
            adaptive=True,
            height=30,
